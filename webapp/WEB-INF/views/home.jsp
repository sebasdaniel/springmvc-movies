    ...
    ================================================== -->
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<ol class="carousel-indicators">
				<c:forEach items="${ banners }" varStatus="loopStatus">
					<c:choose>
						<c:when test="${ loopStatus.index == 0 }">
							<li data-target="#myCarousel" data-slide-to="${ loopStatus.index }" class="active"></li>
						</c:when>
						<c:otherwise>
							<li data-target="#myCarousel" data-slide-to="${ loopStatus.index }"></li>
						</c:otherwise>
					</c:choose>
				</c:forEach>
			</ol>
			...
			<div class="carousel-inner" role="listbox">
				<c:forEach items="${ banners }" var="banner" varStatus="loopStatus">
					<c:choose>
						<c:when test="${ loopStatus.index == 0 }">
			...
			<div class="row">
				<c:forEach items="${ peliculas }" var="pelicula">
					<div class="col-xs-12 col-sm-6 col-md-3">
						<img class="img-rounded" src="${ urlPublic }/images/${ pelicula.imagen }" alt="image" width="150" height="200">
						...
						<div class="blog-post">
							...
							<p class="blog-post-meta">
								<span class="label label-danger">
									Publicado: <fmt:formatDate value="${ noticia.fecha }" pattern="dd-MM-yyyy"/>
								</span>
							</p>
							<p>
								${ noticia.detalle }

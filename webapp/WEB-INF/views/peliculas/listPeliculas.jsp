...
<html lang="en">
  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <a href="${ urlCreate }" class="btn btn-success" role="button" title="Nueva Pelicula" >Nueva</a>
      <br><br>
        	...
        	<c:forEach items="${ peliculas.content }" var="pelicula">
        		<tr>
	                ...
	                <td>
	                    ...
	                    <a href="${ urlDelete }/${ pelicula.id }" onclick="return confirm('¿Esta seguro?');" class="btn btn-danger btn-sm" role="button" title="Eliminar" >

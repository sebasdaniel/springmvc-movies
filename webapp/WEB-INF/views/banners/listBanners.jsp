        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <c:forEach items="${ banners }" var="banner">
            	<tr>
	                ...
	                <td>
	                    <a href="${ urlRoot }banners/edit/${ banner.id }" class="btn btn-success btn-sm" role="button" title="Edit" >
	                    	<span class="glyphicon glyphicon-pencil"></span>
                    	</a>
	                    <a href="${ urlRoot }banners/delete/${ banner.id }" class="btn btn-danger btn-sm" role="button" title="Eliminar" >
